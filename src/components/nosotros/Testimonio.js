const stats = [
  ...
  export default function Testimonio() {
    return (
      <div className="relative bg-black py-16 sm:py-14">
        <div className="mx-auto lg:mx-3 lg:grid lg:max-w-full lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
          <div className="relative sm:py-16 lg:py-0">
            <div aria-hidden="true" className="hidden sm:block lg:absolute lg:inset-y-0 lg:right-0 lg:w-screen">
              <div className="absolute inset-y-0 right-1/2 w-full rounded-r-3xl bg-pizarra lg:right-72" />
              <svg
