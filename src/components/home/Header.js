    ...
    return(
        <main>
          <div className="w-full  bg-black bg-opacity-60 top-0 content">
            <div className="-z-40 w-full bg-black top-0">
        ...
        <div className="relative px-6 lg:px-8 pt-10">
          <div className="mx-auto max-w-3xl  sm:pt-40 sm:pb-40">
            <div>
              <div className="-mt-16 hidden sm:flex sm:justify-center">
                <div className="relative pb-8">
                <img src={logotipo_lg} width={666} className='' />
                </div>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-slate-200 tracking-wide sm:text-center sm:text-7xl pt-4 pb-4 ">
                  Nosotros
                </h3>
                    <h2 className="text-7xl text-center font-bold tracking-tight py-2 ">                        
                ...
                <ul className='flex gap-8 place-content-center pt-16 pb-12'>
